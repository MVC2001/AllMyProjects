...
function addUser($connect, $fullName,$role,$school, $email, $password) {
    ...
    $insertQuery = mysqli_query($connect, "INSERT INTO `users` (`fullName`, `role`,`school`, `email`, `password`) VALUES ('$fullName', '$role','$school', '$email', '$hashedPassword')");
    if ($insertQuery) {
...
if (isset($_POST['add-function'])) {
    ...
    $result = addUser($connect, $fullName, $role,$school, $email, $password);

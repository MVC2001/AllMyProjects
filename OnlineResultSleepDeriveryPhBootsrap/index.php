                                ...
                                <div class="auth-form">
                                    ...
                                    <form action="" method="POST">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" required class="form-control" value="eg. nyemamudhihir@example.com">
                                        </div>
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input type="password" name="conf-password" class="form-control" required value="Comfirm-Password">
                                        </div>

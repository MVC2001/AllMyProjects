        ...
        <div class="quixnav" style="background-color:#11517c;">
            <div class="quixnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                        class="fa fa-list"></i><span class="nav-text">Result-Sleeps</span></a>
                <ul aria-expanded="false">
                    <li><a href="./viewSleep.php">View</a></li>
                </ul>
            </li>

            
            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                class="fa fa-list"></i><span class="nav-text">Requests For-sleep</span></a>
        <ul aria-expanded="false">
            <li><a href="./allRequets.php">View</a></li>
        </ul>
    </li>
                            ...
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    <div class="stat-text">Result-Sleeps</div>
                                     <?php
                           $count = mysqli_query($connect,"SELECT resultsleep_tbl.school, users.school FROM resultsleep_tbl JOIN users ON resultsleep_tbl.school = users.school WHERE user_id=$_SESSION[user_id]   ORDER BY id DESC") or die(mysqli_error($connect));
                            ...
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    <div class="stat-text">Requests</div>
                                      <?php
                           $countv1 = mysqli_query($connect,"SELECT request_tbl.school, users.school FROM request_tbl  JOIN users ON request_tbl.school = users.school WHERE user_id=$_SESSION[user_id]   ORDER BY id DESC") or die(mysqli_error($connect));

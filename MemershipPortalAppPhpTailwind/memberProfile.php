...
<div class="p-4 sm:ml-64">
   <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
    ...
    <form method="POST" action="">
     <?php
                $select_role = "select * from users where user_id = '" .$_GET['user_id']. "' " ;
  ...
  <div class="-mx-3 md:flex mb-6">
    ...
    <div class="md:w-1/2 px-3">
      ...
      <input name="password"  required value="" required minlength="8" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4" id="grid-last-name" type="password" placeholder="">
    </div>
  </div>

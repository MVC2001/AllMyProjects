...
$password =md5($_POST["password"]);
 ...
 $update_role = "UPDATE users SET  name='$name',email='$email',role='$role',password='$password'
  ...
  <div class='p-2 bg-indigo-800 items-center text-indigo-100 leading-none lg:rounded-full flex lg:inline-flex' role='alert'>
    <span class='flex rounded-full bg-indigo-500 uppercase px-2 py-1 text-xs font-bold mr-3'>Account</span>
    <span class='font-semibold mr-2 text-left flex-auto'>Have been changed successfull</span>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) { ?>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-4">
													...
													<button class="btn btn-primary" name="updateAccount" type="submit">Save changes</button>
												</div>
											</div>

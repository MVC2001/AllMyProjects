...
<div class="relative overflow-x-auto shadow-xl sm:rounded-lg">
    ...
    <br><br>
    <table name="" class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
             <?php 
                 $count=1;
                 $select_all_roles = "select * from membership_tbl where  Member_type='Silver'" or die(mysqli_error($connect));

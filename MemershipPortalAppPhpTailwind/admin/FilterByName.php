                  ...
                  if(isset($_GET['search']))
                                    {
                                        ...
                                        $query = "SELECT * FROM membership_tbl WHERE CONCAT(SME_Name, TIN_Number, VAT_regNo, Member_type, email, Website, Telephone, Sector, Business_LicenseNo, Postal_Address, Fullname, membershipID, region, district, cv_path,status,approved_from,approved_upTo) LIKE '%$filtervalues%' ";

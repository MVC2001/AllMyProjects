         ...
         $membershipID  =$_POST["membershipID"];
          $cv_path  =$_POST["cv_path"];
           $district =$_POST["district"];
            $region =$_POST["region"];
             $status =$_POST["status"];
             $approved_from =$_POST["approved_from"];
               $approved_upTo =$_POST["approved_upTo"];
              


 $update_member = "UPDATE membership_tbl SET SME_Name='$SME_Name',TIN_Number='$TIN_Number',VAT_regNo='$VAT_regNo',Member_type='$Member_type',email='$email',Website ='$Website',Telephone='$Telephone',Sector='$Sector',Business_LicenseNo='$Business_LicenseNo',Postal_Address='$Postal_Address',Fullname='$Fullname',membershipID='$membershipID',cv_path='$cv_path',district ='$district',region ='$region',status='$status',approved_from='$approved_from',approved_upTo='$approved_upTo'
    WHERE  id='$id'";

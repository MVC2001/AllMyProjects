...
<div class="relative overflow-x-auto shadow-xl sm:rounded-lg">
    ...
    <table name="" id="userTable" class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
             <?php 
                 $count=1;
                 $select_all_roles = "select * from membership_tbl  where status='Approved 1'" or die(mysqli_error($connect));
                ...
                <td class="px-6 py-4">
                 ...
                 <td class="px-6 py-4">
                  <button class="bg-gray-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
                   <a href="MessagesPannel.php">Send message</a>
                  </button>
                </td>
                
                <td class="px-6 py-4">
                  <?php echo $row['approved_from'];?>
                </td>
                <td class="px-6 py-4">
                  <?php echo $row['approved_upTo'];?>
                </td>
            </tr>   <?php $count++?>

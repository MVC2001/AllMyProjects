...
<div class="p-4 sm:ml-64">
 ...
 <?php
         $query= "SELECT membership_tbl.id,membership_tbl.email,membership_tbl.status,  
          membership_tbl.email FROM membership_tbl INNER JOIN users ON users.email = membership_tbl.email"; 

...
public class InventoryCntrroller {
    ...
    public ResponseEntity<Inventory> getCustomerById(@PathVariable Long id){
    ...
    public List<Inventory> searchInventory(@RequestParam String searchText) {
        return inventoryService.searchInventory(searchText);
    }
}

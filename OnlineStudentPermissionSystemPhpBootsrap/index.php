                ...
                <div class="col-md-6">
                    <div class="authincation-content">
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                            <br>
                            <center><p class="text-secondary" style="box-shadow: rgba(17, 17, 26, 0.1) 0px 1px 0px;"><b>ONLINE STUDENT PERMISSION MANAGEMENT SYSTEM<b></p></center>
                                <div class="auth-form">
                                    ...
                                    <form action="" method="POST">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" required class="form-control" value="eg. nyemamudhihir@gmail.com">
                                        </div>
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input type="password" name="conf-password" class="form-control" required value="Password">
                                        </div>
                                        <div class="form-row d-flex justify-content-between mt-4 mb-2">
                                        </div>
                                        <div class="text-center">
                                            <button type="submit" name="login" class="btn btn-secondary btn-block">Sign me in</button>
                                        </div>
                                    </form>

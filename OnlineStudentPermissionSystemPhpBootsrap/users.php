        ...
        <div class="quixnav">
            <div class="quixnav-scroll">
                <ul class="metismenu" id="menu">
                    <li class="nav-label first">USERS-LISTS-PANEL</li><hr>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <button class="btn btn-dark btn-block" style="width:300px;background-color:gray"><a href="users-registration.php">AddNew-User</a></button>
                            </div>
                            <div class="card-body">

...
function updateUser($connect, $email, $password, $role, $name) {
    // Hash the password
...
if (isset($_POST['update-function'])) {
    ...
    $result = updateUser($connect, $email, $password, $role, $name);
                                ...
                                <div class="basic-form">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-sm-6 mt-2 mt-sm-0">
                                                <input name="fullName" value="<?php echo $row['fullName']; ?>" required type="text" class="form-control" placeholder="fuliname">
                                            </div>
                                             <div class="col-sm-6 mt-2 mt-sm-0">

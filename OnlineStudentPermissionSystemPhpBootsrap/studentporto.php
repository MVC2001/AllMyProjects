            ...
            <div class="quixnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                     ...
                     <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                                class="fa fa-list"></i><span class="nav-text">Cteate-new-permission</span></a>
                        <ul aria-expanded="false">
                            <li><a href="./createNewPermission.php">Request here</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-3 col-sm-12">
                        <div class="card" style="width:600px;height:150px">
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    <div class="stat-text">Permission Status</div>
                                   <?php 
...
if ($number > 0) {
    while($row = mysqli_fetch_assoc($result)) { 
        ...
        <div class="stat-digit">
            ...
            <p style="color:red">Permission Not Found (404)<p>
        </div>
    <?php } ?>      
                                </div>
                            </div>
